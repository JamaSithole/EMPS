...
public class SmsLocator extends org.apache.axis.client.Service implements _205._76._14._196.Sms {
    ...
    private java.lang.String smsSoap_address = "http://www.mobileadvantage.co.za/svc/sms.asmx";
    ...
    public _205._76._14._196.SmsSoap getsmsSoap() throws javax.xml.rpc.ServiceException {
    ...
    public _205._76._14._196.SmsSoap getsmsSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            _205._76._14._196.SmsSoapStub _stub = new _205._76._14._196.SmsSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (_205._76._14._196.SmsSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                _205._76._14._196.SmsSoapStub _stub = new _205._76._14._196.SmsSoapStub(new java.net.URL(smsSoap_address), this);
                _stub.setPortName(getsmsSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://196.14.76.205/", "sms");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://196.14.76.205/", "smsSoap"));
        }
